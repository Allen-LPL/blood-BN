...
public class SupplyGroupByFieldCodeDeserializer extends JsonDeserializer<Integer> {
    ...
    public Integer deserialize(JsonParser parser, DeserializationContext context) throws IOException {
        ...
        for (SupplyGroupByFieldEnum groupByFieldEnum : SupplyGroupByFieldEnum.values()) {
